...
web views를 사용하는 앱에서 Javascript 코드로 Adjust 추적을 사용하고자 할 경우에는 [iOS web views SDK 설명서][doc/ko-sdks/ios_web_views.md]를 참조하십시오. 
...
이 환경은 실제 트래픽과 테스트 장치의 테스트 트래픽을 구별하기 위해 사용합니다. 이 값은 항상 유의미하게 유지해야 합니다! 매출 추적 시 특히 중요합니다.
